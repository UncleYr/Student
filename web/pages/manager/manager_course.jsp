		...
		<table>
			...
			<c:forEach items="${requestScope.courses}" var="course">
				<tr>
					...
					<td><a href="/student/courseServlet?action=update&id=${course.id}">修改</a></td>
					<td><a class="deleteClass" href="/student/courseServlet?action=delete&id=${course.id}">删除</a></td>
				</tr>
			</c:forEach>
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td><a href="pages/manager/course_edit.jsp">添加课程</a></td>
			</tr>	
		</table>
